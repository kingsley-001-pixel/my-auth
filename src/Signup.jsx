...
function Signup() {
    ...
    return (
        <div className="bg-slate-50 overflow-hidden flex justify-center items-center min-h-screen text-slate-900 font-roboto dark:bg-slate-700 
        ">
            {/* TOGGLE THEME BUTTON */}
            ...
            ">
            <div className="
            bg-gradient-to-r overflow-hidden from-blue-500 to-indigo-600 w-screen py-3 font-bold m-0 space-y-2 text-xl pl-12
